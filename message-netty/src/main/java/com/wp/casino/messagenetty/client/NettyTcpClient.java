package com.wp.casino.messagenetty.client;
 ...
 */
public abstract class NettyTcpClient extends BaseService {
    ...
    public ChannelFuture connect(String host, int port, Listener listener) {
        return bootstrap.connect(new InetSocketAddress(host, port)).addListener((ChannelFuture f) -> {
