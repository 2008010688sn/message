package com.wp.casino.messagenetty.server;

import com.wp.casino.messageapi.service.BaseService;
import com.wp.casino.messageapi.service.Listener;
import com.wp.casino.messageapi.service.ServiceException;
import com.wp.casino.messagenetty.deec.MessageDecoder;
import com.wp.casino.messagenetty.deec.MessageEncoder;
import com.wp.casino.messagetools.thread.ThreadNames;
 ...
 */
public abstract class NettyTcpServer extends BaseService {
...
//        }
    ...
    protected ChannelHandler getEncoder() {
        return MessageEncoder.INSTANCE;//每连上一个链接调用一次, 所有用单利
    }
